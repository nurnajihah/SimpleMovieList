...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Step 1c: Link the UI element to the Java variable
        ...
        // Step 3b: Initialize the ArrayAdapter and link it to the ArrayList
        aaMovie = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, alMovieList);

        // Step 4: Link the ListView to the ArrayAdapter
